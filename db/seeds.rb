...
#create stores 
# store1 = FactoryBot.create(:store, name: "CMU-Q", street: "5000 Forbes Avenue", city: "River city", state: "PA", zip: "11111", phone: "1111111111", latitude: 19.999, longitude: 27.888, active: true)
# store2 = FactoryBot.create(:store, name: "TA&M-Q",street: "5000 Forbes Avenue", city: "River city", state: "OH", zip: "22222", phone: "2222222222", latitude: 19.999, longitude: 27.888, active: true)
# store3 = FactoryBot.create(:store, name: "HBKU", street: "5000 Forbes Avenue", city: "River city", state: "WV", zip: "33333", phone: "3333333333", latitude: 19.999, longitude: 27.888, active: true)
# store4 = FactoryBot.create(:store, name: "CMU-P", street: "5000 Forbes Avenue", city: "River city", state: "PA", zip: "44444", phone: "4444444444", latitude: 19.999, longitude: 27.888, active: false)
...
#create assignments 
assignment1 = FactoryBot.create(:assignment, employee_id: 1, store_id: 1, start_date: "2018/05/07", end_date: "2018/11/11", pay_level: 1)
assignment2 = FactoryBot.create(:assignment, employee_id: 2, store_id: 3, start_date: "2019/02/02", end_date: nil, pay_level: 2)
assignment3 = FactoryBot.create(:assignment, employee_id: 3, store_id: 3, start_date: "2019/04/12", end_date: nil, pay_level: 3)
assignment4 = FactoryBot.create(:assignment, employee_id: 4, store_id: 2, start_date: "2018/03/03", end_date: "2019/03/03", pay_level: 4)
assignment5 = FactoryBot.create(:assignment, employee_id: 4, store_id: 1, start_date: "2019/03/03", end_date: nil, pay_level: 5)
...
#create jobs
job1 = FactoryBot.create(:job, name: "Creamery Cleaner", description: "clean creamery", active: true)
...
flavor4 = FactoryBot.create(:flavor, name: "Vanilla & Chocolate", active: false)
...
store_flavor1 = FactoryBot.create(:store_flavor, store_id: 1, flavor: flavor1)
store_flavor2 = FactoryBot.create(:store_flavor, store_id: 2, flavor: flavor2)
store_flavor3 = FactoryBot.create(:store_flavor, store_id: 3, flavor: flavor3)
store_flavor4 = FactoryBot.create(:store_flavor, store_id: 2, flavor: flavor4)
